#' This script fits a cross-sectional linear factor model creating industry
#' factors, where the industry factors are constrained to be uncorrelated with
#' the market as described in A. Meucci, "Risk and Asset Allocation", Springer,
#' 2005,  Chapter 3.
#'
#' @references
#' A. Meucci - "Exercises in Advanced Risk and Portfolio Management"
#' \url{http://symmys.com/node/170}, "E 123 - Cross-section factors: generalized
#' cross-section industry factors".
#'
...
# consider first stocks only to lower run time (comment this line otherwise)
X <- X[,1:30]
