#' This script displays the cdf of the copula of a normal distribution, as
...
#' \url{http://symmys.com/node/170}, "E 35 - Cdf of the normal copula".
#'
...
persp(GridSide1, GridSide2, F_U, theta = 7 * 45, phi = 30, expand = 0.6,
	  col = 'lightblue', shade = 0.75, ltheta = 120, ticktype = 'detailed',
	  xlab = "U_1", ylab = "U_2", zlab = "copula cdf");
