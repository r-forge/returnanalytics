...
#' factors, as described in A. Meucci, "Risk and Asset Allocation", Springer,
#' 2005,  Chapter 3.
#'
#' @references
#' A. Meucci - "Exercises in Advanced Risk and Portfolio Management"
#' \url{http://symmys.com/node/170}, "E 122 - Cross-section factors:
#' unconstrained cross-section industry factors".
#'
