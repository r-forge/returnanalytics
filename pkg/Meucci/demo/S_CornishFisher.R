#'This script compares the Cornish-Fisher estimate of the VaR with the true
#'analytical VaR under the lognormal assumptions as described in A. Meucci,
#'"Risk and Asset Allocation", Springer, 2005,  Chapter 5.
#'
#' @references
#' A. Meucci - "Exercises in Advanced Risk and Portfolio Management"
#'  \url{http://symmys.com/node/170}, "E 223 - Cornish-Fisher approximation of
#' the Value-at-Risk".
#'
...
lines(c, Q_CF)
legend("topleft", 1.9, c("true", "Cornish-Fisher approx"),
