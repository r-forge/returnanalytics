#' This script considers a bivariate normal market and display the correlation
#' and the condition number of the covariance matrix, as described in A. Meucci,
#' "Risk and Asset Allocation", Springer, 2005, Chapter 2.
#'
#' @references
#' A. Meucci - "Exercises in Advanced Risk and Portfolio Management"
#' \url{http://symmys.com/node/170}, "E 84 - Correlation in normal markets".
#'
...
################################################################################
### Iterate of rho values and compute the correlation and condition number for
### (n in 1 : nrhos)
...
for (n in 1:nrhos) {
    ...
    Correlation <- diag(1 / Standard_Deviation) %*% Covariance %*%
    			   diag(1 / Standard_Deviation)
