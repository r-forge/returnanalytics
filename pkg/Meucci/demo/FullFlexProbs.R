...
#' 
#' Pricing function to apply to each scenario in order to generate the P&L
#' distribution, as described in A. Meucci, "Personalized Risk Management: 
#' Historical Scenarios with Fully Flexible Probabilities", GARP Risk
...
#' This script uses Entropy Pooling to compute Fully Flexible Probabilities for
#' historical scenarios based on time periods, market conditions, constraints on
#' moments, etc., as described in A. Meucci, "Personalized Risk Management:
#' Historical Scenarios with Fully Flexible Probabilities", GARP Risk
#' Professional, Dec 2010, p 47-51
#'
...
u     <- -rbind(-matrix(1, N / 2, 1), matrix(1, N / 2, 1))
PnL_u <- PnL %*% u
